...
$transaksi = mysqli_query($koneksi, "SELECT t.*, c.nama_customer, i.nama_item 
    FROM transaction t 
...
<div class="container mt-5">
  ...
  <!-- Form Tambah -->
  <form action="proses_transaction.php" method="POST" class="row g-3">
  ...
  <table class="table table-bordered table-striped mt-4">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="transaction_edit.php?id=<?= $row['id_transaksi'] ?>" class="btn btn-warning btn-sm">Edit</a>
          <a href="proses_transaction.php?aksi=hapus&id=<?= $row['id_transaksi'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus?')">Hapus</a>
        </td>
      </tr>
      <?php endwhile; ?>
    </tbody>
