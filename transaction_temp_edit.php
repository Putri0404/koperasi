...
$data = mysqli_query($koneksi, "SELECT * FROM transaction_temp WHERE id_transaksi_temp = $id");
...
<div class="container mt-5">
  <h3>Edit Transaksi Sementara</h3>
  <form action="proses_transaction_temp.php" method="POST">
    <input type="hidden" name="aksi" value="edit">
    <input type="hidden" name="id" value="<?= $row['id_transaksi_temp'] ?>">
    ...
    <a href="transaction_temp.php" class="btn btn-secondary">Batal</a>
  </form>
</div>
</body>
</html>
