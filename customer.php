...
<body>
  ...
  <div class="sidebar d-flex flex-column">
    ...
    <a href="customer.php" class="nav-link active"><i class="bi bi-people"></i> Customer</a>
  ...
  <div class="main-content">
    ...
    <form action="proses.php" method="POST" class="row g-3">
      ...
      <div class="col-md-1">
        <input type="text" name="id_customer" class="form-control" placeholder="ID" required>
      </div>
      <div class="col-md-4">
      ...
      <tbody>
        <?php while($row = mysqli_fetch_assoc($data)): ?>
          <tr>
            ...
            <td><?= $row['telp'] ?></td>
            <td>
              <a href="customer_edit.php?id=<?= $row['id_customer'] ?>" class="btn btn-sm btn-warning">Edit</a>
              <a href="proses.php?aksi=hapus&id=<?= $row['id_customer'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus?')">Hapus</a>
            </td>
          </tr>
        <?php endwhile; ?>
      </tbody>
