...
if ($_POST['aksi'] == 'tambah') {
    ...
    mysqli_query($koneksi, "INSERT INTO transaction (tanggal, id_customer, id_item, jumlah, total) 
...
if ($_POST['aksi'] == 'edit') {
    ...
    mysqli_query($koneksi, "UPDATE transaction 
...
if ($_GET['aksi'] == 'hapus') {
    $id = $_GET['id'];
    mysqli_query($koneksi, "DELETE FROM transaction WHERE id_transaksi=$id");
    header("Location: transaction.php");
    exit();
}
