...
<body>
  ...
  <div class="sidebar d-flex flex-column">
    ...
    <a href="./item.php" class="nav-link active"><i class="bi bi-box-seam"></i> Item</a>
  ...
  <div class="main-content">
    ...
    <!-- Form Tambah -->
    <form action="proses_item.php" method="POST" class="row g-3">
    ...
    <table class="table table-bordered table-striped mt-4">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="item_edit.php?id=<?= $row['id_item'] ?>" class="btn btn-warning btn-sm">Edit</a>
            <a href="proses_item.php?aksi=hapus&id=<?= $row['id_item'] ?>" onclick="return confirm('Yakin hapus item ini?')" class="btn btn-danger btn-sm">Hapus</a>
          </td>
        </tr>
        <?php endwhile; ?>
      </tbody>
